function ageInDays() {
  ...
  var birthdays = (2022 - birthYear) * 365;
  var h1 = document.createElement("h1");
  var textAnswer = document.createTextNode(
    "You are " + birthdays + " days old"
  );
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage) {
  ...
  humanDiv.innerHTML = "<img src='" + imagesDatabase[humanImageChoice] + "' height=150 width=150 style='box-shadow: 0px 10px 50px rgb(30, 30, 131);'>"
